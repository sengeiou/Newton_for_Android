package com.leleliu008.newton.framework.ui.popup;
...
public class CustomPopup extends PopupWindow {
    ...
    protected Animation getInAnimation() {
    	return AnimationUtils.loadAnimation(activity, R.anim.push_left_in);
	}
    
    protected Animation getOutAnimation() {
    	return AnimationUtils.loadAnimation(activity, R.anim.back_right_out);
	}
}
